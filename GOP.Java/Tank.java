 ...
 * Tank obejects that extend enemies 
 * are the second hardest type of enemies and mostly found in mid waves
 * June 14, 2017
 */
...
class Tank extends Enemy{
  ...
  Tank(int x, int y,int health){
    super(x, y,health);
    image = Toolkit.getDefaultToolkit().getImage("tank.png"); 
  }
  ...
  void move(double elapsedTime){ 
    if (mapChooser.getMapChosen() == 1){ // if map 1 chosen 
      if (super.getX() <10 * hor - hor/2 -10&& super.getY() == 2  * ver ){ //condition that will 
        ...
        image = Toolkit.getDefaultToolkit().getImage("tank0.png");
        ...
        image = Toolkit.getDefaultToolkit().getImage("tank270.png");
        ...
        image = Toolkit.getDefaultToolkit().getImage("tank180.png");
        ...
        image = Toolkit.getDefaultToolkit().getImage("tank90.png");
