 ...
 * Plane obejects that extend enemies 
 * are the hardest type of enemies and mostly found in later waves
 * June 14, 2017
 */
...
class Plane extends Enemy{
  ...
  Plane(int x, int y,int health){
    super(x, y,health);
    image = Toolkit.getDefaultToolkit().getImage("plane.png");
  }
      /*move 
   * Ali Meshkat 
  ...
  void move(double elapsedTime){ 
    if (mapChooser.getMapChosen() == 1){ // if map 1 chosen 
      if (super.getX() <10 * hor - hor/2 -10&& super.getY() == 2  * ver ){ //condition that will 
        ...
        image = Toolkit.getDefaultToolkit().getImage("plane0.png");
        ...
        image = Toolkit.getDefaultToolkit().getImage("plane270.png");
        ...
        image = Toolkit.getDefaultToolkit().getImage("plane180.png");
        ...
        image = Toolkit.getDefaultToolkit().getImage("plane90.png");
  ...
  void display(Graphics g){
    //g.drawImage(plant,this.x,this.y,10,10,this);
  }
}