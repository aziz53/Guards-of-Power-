 ...
 * Helicopter obejects that extend enemies 
 * are the second easiest type of enemy and found in early game
 * June 14, 2017
 */
...
class Helicopter extends Enemy{
  ...
  Helicopter(int x, int y,int health){
    super(x, y,health);
    image = Toolkit.getDefaultToolkit().getImage("helicopter1.png");
  }
      /*move 
   * Ali Meshkat 
  ...
  void move(double elapsedTime){ 
    if (mapChooser.getMapChosen() == 1){ // if map 1 chosen 
      if (super.getX() <10 * hor - hor/2 -10&& super.getY() == 2  * ver ){ //condition that will 
        ...
        image = Toolkit.getDefaultToolkit().getImage("helicopter0.png");
        ...
        image = Toolkit.getDefaultToolkit().getImage("helicopter270.png");
        ...
        image = Toolkit.getDefaultToolkit().getImage("helicopter180.png");
        ...
        image = Toolkit.getDefaultToolkit().getImage("helicopter90.png");
